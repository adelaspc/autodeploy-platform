...
from backend.api.request_context import current_request_id
from backend.extensions import db
from backend.models import AuditEvent
from backend.security import REDACTED, redact_sensitive_data
...
def record_audit_event(
    *,
    ...
    from backend.api.auth import current_request_actor_role
