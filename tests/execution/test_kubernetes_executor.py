...
def test_kubernetes_executor_helm_mode_deploys_with_generated_values_and_release_name(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("worker.executors.kubernetes.helm.generic_web_app_values", fake_values_generator)
    monkeypatch.setattr("worker.executors.kubernetes.helm.helm_release_name", fake_release_name)
